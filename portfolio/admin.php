...
<body>
    <div class="container-fluid">
        <h4 class="display-3  text-center" style="color:white;">Welcome Admin Michael</h4>
        ...
        <form method="post" action="" id="form">
            ...
            <button type="submit" class="btn btn-light" name="submit" style="margin-left:20px;" href="adminpannel.php">Submit</button>
